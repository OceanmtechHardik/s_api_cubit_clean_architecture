...
abstract class HomeDataWigets extends State<HomeDataScrene> {
  ...
  ///catagoriList
  Widget categoriesView({required HomeLoadedState state}) {
...
//   ///Bestsellers
  Widget bestsellersView({required HomeLoadedState state}) {
    return Column(
  ...
  ///HOT DEALS Widgets
  Widget hotDealsView({required HomeLoadedState state}) {
  ...
  ///TopPick Widgets
  Widget topPicksView({required HomeLoadedState state}) {
...
//SUGAR BEAUTY BLOG Widgets
  Widget sugarWidgets({required HomeLoadedState state}) {
...
//   ///JUSTIN && TRY BEFORE Widgets
  Widget justInView({required HomeLoadedState state}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  Widget giftingWidgetView({required HomeLoadedState state}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  ///SuperSavers Widgets
  Widget superSaversView({required HomeLoadedState state}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
  ...
  ///NewlyWidget
  Widget newlylaunchedSection({required HomeLoadedState state}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        textItems(text: "${state.productDataEntity[9].title}", color: black, size: 20),
  ...
  ///referFriend
  Widget referFriendView({required HomeLoadedState state}) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
...
//////THIS OR THAT
  ...
  ///SkINCARE BASICCS
  Widget skincareBasicsSection({required HomeLoadedState state}) {
